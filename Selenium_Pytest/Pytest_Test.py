...
def test_work_flow(test_test_Setup):
 driver=test_test_Setup
 ...
 Scroll_Into_Product = wait.until(
     EC.visibility_of_element_located((By.XPATH, '//div[text()="SONY 80 cm (32 inch) HD Ready LED Smart Google TV"]')))
 driver.execute_script("arguments[0].scrollIntoView();", Scroll_Into_Product)
 driver.save_screenshot("Scroll_Into_Product.png")

 Click_Into_Product = wait.until(EC.visibility_of_element_located(
     (By.XPATH, '//div[text()="SONY BRAVIA 2 II 189.3 cm (75 inch) Ultra HD (4K) LED Smart Google TV 2025 Edition"]')))
 ...
 Assert_page = wait.until(EC.visibility_of_element_located((By.XPATH,
                                                            '//a[text()="SONY BRAVIA 2 II 189.3 cm (75 inch) Ultra HD (4K) LED Smart Google TV 2025 Edition"]'))).text

 try:
     assert Assert_page =="SONY BRAVIA 2 II 189.3 cm (75 inch) Ultra HD (4K) LED Smart Google TV 2025 Edition"
     print("Matced Test Case Passed")
 except AssertionError:
     print("Unmatced Test Case Faild")
